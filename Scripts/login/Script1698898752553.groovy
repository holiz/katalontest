...
WebUI.click(findTestObject('Object Repository/Login/Page_Swag Labs/button_Open Menu'))

WebUI.click(findTestObject('Object Repository/Login/Page_Swag Labs/a_Logout'))
